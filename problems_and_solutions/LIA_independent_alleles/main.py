...
FILEPATH = r"LIA_independent_alleles\data.txt"
...
def main():
    ...
    p_less_than_n = sum(math.comb(population, d) * (p_AaBb**d) * ((1 - p_AaBb)**(population - d)) for d in range(n))

    print(round(p_less_than_n, 3))
