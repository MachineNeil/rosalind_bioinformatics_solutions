...
FILEPATH = r"PMCH_perfect_matching_and_rna_secondary_structures\data.txt"

def main():
    sequence = SeqIO.read(FILEPATH, "fasta").seq
    au = factorial(sequence.count("G"))
    cg = factorial(sequence.count("C"))
    all_possibilities = au * cg * 2
