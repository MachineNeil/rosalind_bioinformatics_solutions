...
FILEPATH = r"INDC_independent_segregation_of_chromosomes\data.txt"
...
def main():
    ...
    probabilities = [p_bin(2 * n, 0.5, i) for i in range(1, 2 * n + 1)]
    result = [log10(sum(probabilities[i:])) for i in range(len(probabilities))]
